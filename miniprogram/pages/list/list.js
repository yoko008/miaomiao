...
Page({
     ...
     */
    onShow: function() {
        console.log(this.data.accountBookName + "---" + app.globalData.userInfo.accountBookName);
        if (this.data.accountBookName != app.globalData.userInfo.accountBookName){
            this.setData({
                shouzhi: "全部",
                acc1: "全部",
                acc2: "全部",
